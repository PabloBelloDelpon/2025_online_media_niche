...
###--- WSJ to use as ideology cutoff point
wsj_ideo <-
...
ideo_egos <-
  ...
  mutate(ideo_bi = ifelse(ideo_est > wsj_ideo, "Conservative", "Liberal"))
...
###--- Exposure volume
exposure_data <- readRDS("data/ego_alter_domain_tabs_binary_wsj_cutpoint.rds")
