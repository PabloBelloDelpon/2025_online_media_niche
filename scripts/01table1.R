...
ideo_egos <-  
  ...
  mutate(ideo_bi = ifelse(ideology_new > nyt_ideo, "Conservative", "Liberal")) %>% 
...
###--- Exposure Volume 
data <-  readRDS("data/main/ego_alter_domain_tabs_binary.RDS")
...
table1 <- xtable(tbl)
print(table1, type = "html", file = "output/table1.html", include.rownames = FALSE)
